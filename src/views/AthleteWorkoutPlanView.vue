<template>
  <div class="motherFlex2 flex-column">
    <AthleteNavBar/>
...
<!--        &lt;!&ndash;          <button v-on:click="navigateToExerciseView"&ndash;&gt;-->
<!--        &lt;!&ndash;                  type="button" class="col col-1 m-1 btn btn-success">Muuda</button>&ndash;&gt;-->
<!--        &lt;!&ndash;          <button type="button" class="col col-1 m-1 btn btn-success">Kustuta</button>&ndash;&gt;-->
